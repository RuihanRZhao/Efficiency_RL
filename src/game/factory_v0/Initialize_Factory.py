...
def Initialize_Factory_DB():
    ...
    sql = [
        ...
        "create table Efficiency_RL.object(name varchar(256),storage int,Max_Store int,Max_Extra_Store int) SELECT * FROM Efficiency_RL_Ori.object;",
...
def Initialize_Material():
    ...
    db = DB.Get_DB_Method()
    cursor = db.cursor()
    cursor.execute("select * from Efficiency_RL.object")
